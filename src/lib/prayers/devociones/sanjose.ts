...
export const sanJosePrayer: Prayer = {
  id: 'devocion-san-jose',
  title: 'Devoción a San José',
  categoryId: 'devociones',
  image: '/images/holy-family.jpeg',
  prayers: [
    {
      id: 'san-jose-oracion',
      title: 'Oración',
