...
export const santaTeresaDeLosAndesPrayer: Prayer = {
  id: 'santateresadelosandes',
  title: 'Oración a Santa Teresa de Los Andes',
  content: `Teresa de Los Andes,
...
Amén.`,
  ...
  imageUrl: '/images/santa-teresa-andes.jpeg',
  imageHint: 'Santa Teresa de Los Andes'
};
