...
export const adoroTeDevote: Prayer = {
  ...
  showOnDay: 4, // Thursday
  content: {
    español: `Te adoro con devoción, Dios escondido, oculto verdaderamente bajo estas apariencias. A Ti se somete mi corazón por completo, y se rinde totalmente al contemplarte.
...
Amén.`,
    latín: `Adoro te devote, latens Deitas, Quæ sub his figuris vere latitas; Tibi se cor meum totum subjicit, Quia te contemplans totum deficit.
