...
export const lecturaEspiritual: Prayer[] = [
    {
    id: 'lectura-1',
    title: 'Texto 1: Vida de Fe',
    categoryId: 'plan-de-vida',
    isLongText: true,
    content: `*Evangelio (Mt 8, 5-10):*
...
Seguramente las palabras de Jesús volvieron a extrañar a los allí presentes, pues manifestaba la intención de ir a su casa, siendo que la ley no permitía entrar en el hogar de un gentil. De hecho, el centurión conocía esa costumbre, de ahí que dijera: «Señor, no soy digno de que entres en mi casa. Pero basta que lo digas de palabra y mi criado sanará» (Mt 8, 8). Pero Jesús desea entrar en el corazón de aquel hombre sencillo y necesitado para manifestarle su amor concreto. También nosotros podemos sentirnos indignos de estar con el Señor, pero Dios precisamente viene en busca del más débil, del que ha perdido la autoestima, del que considera que su petición es molesta. Dios ha venido a curar. Y solo espera que, como el centurión, se lo pidamos con humildad y nos acerquemos a Él.

El centurión confía tanto en Jesús que se conforma con una palabra suya para lograr la curación del criado. En el fondo, ha aplicado un razonamiento que conoce bien. Él mismo tiene una autoridad humana por la que los soldados obedecen inmediatamente a sus órdenes: «Le digo a uno: “Vete”, y va; y a otro: “Ven”, y viene» (Mt 8, 9). Por eso a Jesús, que tiene una autoridad divina, le podría bastar una sencilla orden para que la enfermedad desaparezca del cuerpo de su criado. Este planteamiento causó la admiración del Señor y de la muchedumbre: «En verdad os digo que en nadie de Israel he encontrado una fe tan grande. Os digo que muchos de oriente y occidente vendrán y se sentarán a la mesa con Abraham, Isaac y Jacob en el Reino de los Cielos» (Mt 8, 10-11). Y podemos considerar: ¿no es así como a veces responden los niños y también las personas que en la vida espiritual tratan de explorar un camino de infancia?

Jesús elogia la fe de un hombre que, con ojos de la época, pocos dirían que pudiera tener fe, por su condición de gentil (no era judío). Mirar a los demás como Jesús nos lleva a descubrir lo bueno que tienen todas las personas, incluso aquellas que, a simple vista, puedan estar más lejos del Señor. En muchas de ellas, como el centurión, late el deseo de encontrar a un “Dios que tiene un rostro humano y que nos ha amado hasta el extremo, a cada uno en particular y a la humanidad en su conjunto” (Benedicto XVI, *Spe Salvi*, n. 31).

Antes de recibir la Comunión en la santa Misa, repetimos el acto de fe del centurión: «Señor, no soy digno de que entres en mi casa. Pero basta que lo digas de palabra y mi criado quedará sano» (Mt 8, 8). Con esta expresión manifestamos la necesidad que tenemos de ser curados por Cristo: él viene a nuestra alma precisamente para sanar nuestras heridas. «La Eucaristía no es un premio para los buenos, sino la fuerza para los débiles» (Francisco, Homilía, 4-VI-2015).

A lo largo del día podemos alimentar el deseo de que Jesús venga a nuestra casa a través de la comunión espiritual. «Prácticala frecuentemente y tendrás más presencia de Dios y más unión con él en las obras» (San Josemaría, *Camino*, n. 540), sugería san Josemaría. Quizá todos tenemos la experiencia de esperar, durante un tiempo, algo que nos hace especial ilusión: una fiesta, unas vacaciones, la llegada de un ser querido... Tal vez los días anteriores están llenos de preparativos y con nuestra imaginación empezamos a suponer cómo transcurrirá ese momento. Y cuando finalmente se hace presente, afrontamos esa jornada con una ilusión casi proporcional al tiempo de espera.
...
Con la comunión espiritual no solo nos preparamos para recibir al Señor en la Eucaristía, sino que renovamos nuestro deseo de que venga para curarnos. Cuentan que el mismo Jesús en persona confió a santa Faustina Kowalska que si rezamos la comunión espiritual varias veces al día, en tan solo un mes veremos nuestros corazones completamente cambiados. Por eso, le podemos pedir al Señor la fe de los santos, para ser transformados con esa oración. También san José se alimentó de comuniones espirituales durante nueve meses. Soñaba cómo sería el Niño y seguramente hablaría con María acerca de su llegada. Y cuando finalmente nació, sus expectativas quedarían desbordadas: se consideraría el hombre más feliz del mundo al tener entre sus brazos al mismo Dios.`
  ...
  {
    id: 'lectura-2',
    title: 'Texto 2: La Transfiguración',
    categoryId: 'plan-de-vida',
    isLongText: true,
    content: `*Evangelio (Mt 17, 1-9):*
...
*Meditación:*
Jesús quiere aumentar la esperanza de Pedro, Santiago y Juan, manifestando su gloria ante ellos. Sube a un monte alto, acompañado en primer lugar por tres discípulos, de modo análogo a como Moisés subió al monte Sinaí acompañado por Aarón, Nadab y Abihú. Estos mismos tres apóstoles serían aquellos a los que llamaría en Getsemaní para que lo acompañaran más de cerca, mientras los demás quedaban algo más retirados del lugar donde Jesús rezaba en agonía (Mc 14, 33). Contrastan las escenas de esplendor gozoso y sufrimiento angustiado en las que Pedro, Santiago y Juan lo acompañan, pero, a la vez, ambas están inseparablemente relacionadas. No hay gloria sin cruz. En efecto, en la escena de la Transfiguración la Iglesia ha visto una preparación de los apóstoles para sobrellevar el escándalo de la Cruz.
...
“De este episodio de la Transfiguración quisiera tomar dos elementos significativos —dijo el Papa Francisco—, que sintetizo en dos palabras: subida y descenso. Nosotros necesitamos ir a un lugar apartado, subir a la montaña en un espacio de silencio, para encontrarnos a nosotros mismos y percibir mejor la voz del Señor y llenarnos de su Gracia. Esto hacemos en la oración. Pero no podemos permanecer allí. El encuentro con Dios en la oración nos impulsa nuevamente a ‘bajar de la montaña’ y volver a la parte baja, a la llanura, donde encontramos a tantos hermanos afligidos por fatigas, enfermedades, injusticias, ignorancias, pobreza material y espiritual. Nos impulsa a servir. A estos hermanos nuestros que atraviesan dificultades, estamos llamados a llevar los frutos de la experiencia que hemos tenido con Dios, compartiendo la gracia recibida” (Francisco, Ángelus, 16-III-2014).`
  },
  {
    id: 'lectura-3',
    title: 'Texto 3: Parábola de los dos hijos',
    categoryId: 'plan-de-vida',
    isLongText: true,
    content: `*Evangelio (Mt 21, 28-32):*
Dijo Jesús: «¿Qué os parece? Un hombre tenía dos hijos; dirigiéndose al primero, le mandó: “Hijo, vete hoy a trabajar en la viña”. Pero él le contestó: “No quiero”. Sin embargo, se arrepintió después y fue. Se dirigió entonces al segundo y le dijo lo mismo. Éste le respondió: “Voy, señor”, pero no fue. ¿Cuál de los dos hizo la voluntad del padre?» —El primero —dijeron ellos. Jesús prosiguió: «En verdad os digo que los publicanos y las meretrices van a estar por delante de vosotros en el Reino de Dios. Porque vino Juan a vosotros con un camino de justicia y no le creísteis; en cambio, los publicanos y las meretrices le creyeron. Pero vosotros, ni siquiera viendo esto, os arrepentisteis después para poder creerle.»
...
La conclusión de la parábola tiene palabras fuertes: “En verdad os digo que los publicanos y las meretrices van a estar por delante de vosotros en el Reino de Dios” (v. 31). Esto es, los que sufren a causa de sus pecados y tienen deseo de un corazón puro, están más cerca del Reino de Dios que muchos que se llaman cristianos pero que son indolentes. Piensan que ya hacen suficiente y no dejan que el arrepentimiento de sus culpas ni el amor de Dios toque sus corazones.`
  ...
  {
    id: 'lectura-4',
    title: 'Texto 4: Virtudes humanas',
    categoryId: 'plan-de-vida',
    isLongText: true,
    content: `*Surco:*
14.- "¡Es muy difícil!", exclamas desalentado. Oye, si luchas, con la gracia de Dios basta: prescindirás de los intereses personales, servirás a los demás por Dios, y ayudarás a la Iglesia en el campo donde se libra hoy la batalla: en la calle, en la fábrica, en el taller, en la universidad, en la oficina, en tu ambiente, en medio de los tuyos.

770.- Sin el Señor no podrás dar un paso seguro. —Esta certeza de que necesitas su ayuda te llevará a unirte más a Él, con recia confianza, perseverante, ungida de alegría y de paz, aunque el camino se haga áspero y pendiente.
...
654.- Hasta ahora no habías comprendido el mensaje que los cristianos traemos a los demás hombres: la escondida maravilla de la vida interior. ¡Qué mundo nuevo les estás poniendo delante!
...
Decídete —no te ofendas— a tomar en serio a Dios. Esa ligereza tuya, si no la combates, puede acabar en una triste burla blasfema.`
  ...
  {
    id: 'lectura-5',
    title: 'Texto 5: El hijo pródigo',
    categoryId: 'plan-de-vida',
    isLongText: true,
    content: `*Evangelio (Lc 15, 11-32):*
Jesús dijo también: «Un hombre tenía dos hijos. El menor de ellos dijo a su padre: “Padre, dame la parte de herencia que me corresponde”. Y el padre les repartió sus bienes. Pocos días después, el hijo menor recogió todo lo que tenía y se fue a un país lejano, donde malgastó sus bienes en una vida licenciosa... (texto completo del hijo pródigo incluido)»
    
*Meditación:*
El hijo pródigo distingue a lo lejos la finca de su padre y el terreno que la rodea... (texto completo como lo escribiste, sin alterar formato) ...  
La Confesión, por tanto, actúa como luz y como fuerza para combatir las inclinaciones que nos tiran para abajo: la gracia sacramental y la generosa satisfacción del penitente tienen carácter medicinal y sana, en parte, las reliquias que el pecado deja siempre en el alma.`
  },
  {
    id: 'lectura-6',
    title: 'Texto 6: Vida de oración',
    categoryId: 'plan-de-vida',
    isLongText: true,
    content: `*Meditación:*
"No sé cuántas veces te habrás propuesto hacer con constancia un rato de oración cada día. Me imagino que decenas de veces, pero la razón más honda, el obstáculo más insalvable, aquello que hace que ni tú te creas que alguna vez lograrás ser alma de oración es precisamente vivir convencido de que es imposible hablar con Dios de tú a Tú...

(Pausa)

"Si tú y yo no hacemos la oración casi nunca, o cuando la hacemos es por un puro cumplir, es porque ni sabemos hacerla, ni nos creemos que ahí está realmente Dios...

(Pausa)

"Cuando descubras que la oración verdadera es posible, entonces verás que quieres hacerla, que deseas hacerla, que no puedes vivir sin hacerla... Y eso lo cambia todo. Es de Jesucristo de quien te has de fiar, no de un libro, o de una técnica, o de historietas varias que acabarán por agotarte... ¿Tú tienes interés en dejarte enseñar, en dejarte llevar por ese Dios hacia caminos de verdadera oración? Porque para aprender a orar lo primero es dejarse enseñar. Y sobre ese tema, Jesucristo lo sabe todo... Ahora ya solo es cuestión de que tú le dejes. Verás que será algo de lo que jamás te vas a arrepentir."`
  },
  {
    id: 'lectura-7',
    title: 'Texto 7: Apostolado',
    categoryId: 'plan-de-vida',
    isLongText: true,
    content: `*Evangelio (Lc 1, 39-45):*
...
El trayecto es largo. La Virgen vive en Nazaret y su prima cerca de Jerusalén, unos 150 km de camino. Pero María no se detiene ante las dificultades. Se dirige apresuradamente, aunque estuviese también ella embarazada y se arriesgara a encontrarse con salteadores en la ruta hacia el sur. Su ilusión es cuidar de su prima. María es de esas personas que llevan adelante la familia, que enfrentan tantas adversidades, tanto dolor, que curan a los enfermos. Se levantan y sirven. Aquí podemos ver el lema de los trabajos: ¡Trascender para Servir!

No se da importancia a sí misma. No piensa: “como soy la madre de Dios, yo soy la importante”. No, María no piensa así. Su modo de pensar es distinto: “por ser la más digna, tengo que ayudar más”. No se encierra en casa, sino que va a cuidar a su prima. Y no es la prisa alocada, sino la prisa de la ternura. Como señala el Papa Francisco, “María no es la clase de personas que para estar bien necesita un buen sofá donde sentirse cómoda y segura. No es una joven-sofá”. Y de ese encuentro surge la alegría, la alegría profunda de María e Isabel; una alegría que llena sus vidas. Del mismo modo, si aprendemos a servir y vamos al encuentro de los otros, permitimos que Dios cambie este mundo.

El apostolado es servicio: el que está lleno de Dios, naturalmente comparte la Vida de Dios que lleva dentro: la alegría, el sentido de la vida, el sentido del dolor, el sentido del éxito y de los fracasos. Por eso el apóstol busca en primer lugar llenarse de la Gracia en los Sacramentos.

“En el día de la Inmaculada debemos aprender esto —decía Benedicto XVI—: el hombre que se abandona totalmente en las manos de Dios no pierde su libertad. Sólo el hombre que se pone totalmente en manos de Dios encuentra la verdadera libertad, la amplitud grande y creativa de la libertad del bien... Cuanto más cerca está el hombre de Dios, tanto más cerca está de los hombres. Lo vemos en María. El hecho de que está totalmente en Dios es la razón por la que está también tan cerca de los hombres. Por eso puede ser la Madre de todo consuelo y de toda ayuda...” (*Homilía, 8-XII-2005*).

*Surco:*
188.- Naturalidad, sinceridad, alegría: condiciones indispensables, en el apóstol, para atraer a las gentes.

196.- Convéncete: también ahí, hay muchos que pueden entender tu camino; almas que, consciente o inconscientemente, buscan a Cristo y no le encuentran. Pero, ¿cómo oirán hablar de Él, si nadie les habla?
...
*Meditación:*
Nuestro mundo necesita una profunda mejoría, una honda resurrección espiritual. Aunque el Señor lo sabe todo, quiere que, con la misma confianza de aquel jefe de la sinagoga, Jairo —que cuenta la gravedad del estado de su hija: “Mi niña está en las últimas” (Mc 5, 23)—, le digamos cuáles son nuestros problemas, todo lo que nos preocupa o entristece. Y el Señor espera que le dirijamos la misma súplica de Jairo: “Ven, pon las manos sobre ella, para que sane” (Ibíd.).

Deseo recordaros que Dios cuenta con los jóvenes y las jóvenes de Chile para cambiar este mundo. El futuro de vuestra patria depende de vosotros. Vosotros mismos sois un futuro, el cual se configurará como presente según se configuren ahora vuestras vidas. [...] ¡Jóvenes chilenos: No tengáis miedo de mirarlo a Él! Mirad al Señor: ¿Qué veis? ¿Es sólo un hombre sabio? ¡No! ¡Es más que eso! [...] Jesús es la Palabra que Dios tenía que decir al mundo. Es Dios mismo que ha venido a compartir nuestra existencia.
...
Este es, amigos míos, el mensaje de vida que el Papa quiere transmitir a los jóvenes chilenos: ¡Buscad a Cristo! ¡Mirad a Cristo! ¡Vivid en Cristo!`
  },
  {
    id: 'lectura-9',
    title: 'Texto 9: Parábola de los talentos',
    categoryId: 'plan-de-vida',
    isLongText: true,
    content: `*Evangelio (Mt 25, 14-30):*
Dijo Jesús: «El reino de los Cielos es también como un hombre que, al salir de viaje, llamó a sus servidores y les confió sus bienes. A uno le dio cinco talentos, a otro dos, y uno solo a un tercero, a cada uno según su capacidad; y después partió... (texto completo del Evangelio).

*Meditación:*
En la parábola, los talentos representan los bienes del Señor, que Él nos confía para que los hagamos fructificar, pero para hacerlos fructificar hay que atreverse, ser valiente y confiar en el Señor, con amor. Por eso, como dice el Papa, “El hoyo cavado en la tierra por el siervo negligente y holgazán indica el miedo a arriesgar que bloquea la creatividad y la fecundidad del amor”. Jesús no nos pide que guardemos los talentos en una caja fuerte, nos pide que actuemos como los otros dos siervos, que, confiando en el Señor, tomaron el riesgo de usar los talentos por amor. “Es como si Dios nos dijera: ‘Aquí tienes mi misericordia, mi ternura, mi perdón: tómalos y haz amplio uso de ellos’”. Y tú, ¿te atreves a usarlos?`
  },
  {
    id: 'lectura-10',
    title: 'Texto 10: Resurrección de Lázaro',
    categoryId: 'plan-de-vida',
    isLongText: true,
    content: `*Evangelio (Jn 11, 1-45):*
...
*Meditación:*
A pesar de todo, Jesús no acude al instante a la llamada de las hermanas, sino que espera dos días. Y cuando llega a los confines de Betania, Lázaro lleva ya cuatro días muerto. Dice el relato que “todavía no había llegado Jesús a la aldea” (v. 30) cuando llamó en secreto a Marta para que acudiera hasta Él. Marta llega y demuestra su gran fe en Jesús. Luego avisa a María, que se postra ante el Maestro delante de todos, sin respetos humanos, y conmueve al Señor.
...
Una vez abierto el sepulcro, Jesús grita: “¡Lázaro, sal fuera!” (v. 43). Jesús tiene poder sobre la muerte porque también lo tiene sobre el pecado, que es su causa. Por eso, de algún modo, los lienzos que atan y envuelven a Lázaro representan las ligaduras del pecado.

En este pasaje del Evangelio, Marta es ejemplo de las tres actitudes mencionadas antes: optimismo, tenacidad y atrevimiento o coraje de quien cree, espera y ama. ¿En qué situaciones se manifiesta mi optimismo... o pesimismo; mi tenacidad... o inconstancia; mi atrevimiento para amar... o mi temor egoísta?`
  },
  {
    id: 'lectura-11',
    title: 'Texto 11: Vida de cristiano',
    categoryId: 'plan-de-vida',
    isLongText: true,
    content: `*Camino:*
443.- No hagas crítica negativa: cuando no puedas alabar, cállate.

448.- Es más fácil decir qué hacer. —Tú…, que tienes esa lengua tajante —de hacha—, ¿has probado alguna vez, por casualidad siquiera, a hacer bien lo que, según tu opinión, hacen los otros menos bien?

452.- Esfuérzate, si es preciso, en perdonar siempre a quienes te ofendan, desde el primer instante, ya que, por grande que sea la ofensa, más te ha perdonado Dios a ti.
...
537.- Cuando te acerques al Sagrario piensa que Él te espera desde hace veinte siglos.

*Pensamiento:*
1.- ¿Piensas que haces bien al hablar mal del otro? Mejor no pienses y habla menos.

2.- ¿Crees que hablando más que el resto ayudas? Dios te creó con dos orejas y una boca, no al revés.

3.- ¿Crees que te llaman las adicciones? ¡Más te llama el Señor Dios! —El hombre oye lo que desea escuchar e ignora lo que desea ignorar.

4.- Piensa, de ser preciso, en lo mejor para el otro: mortificación no es poca cosa, aunque la encuentres difícil.

5.- ¿Se te hace difícil renunciar a los bienes terrenales? Deshazte de lo innecesario antes de que sea más difícil aún.

6.- Un buen cristiano no anda proclamando a los cuatro vientos lo bueno que es. Haz, como dijo Jesús, el bien a escondidas, que tu mano izquierda no sepa lo que hace tu derecha, y Dios, que está en lo oculto, te recompensará.

7.- La humildad —dicen— resulta fácil. ¿Has pensado siquiera en lo superficial que son aquellos que dicen eso? Te aseguro que quien se autoproclama humilde no lo es.

8.- ¿Se te hace difícil la espera? Jesús te esperó pacientemente durante veinte siglos. ¿No puedes siquiera esperar veinte minutos?
