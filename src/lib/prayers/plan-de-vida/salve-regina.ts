...
export const salveRegina: Prayer = {
  id: 'salve-regina',
  title: 'Salve Regina',
  categoryId: 'plan-de-vida',
  showOnDay: 6, // Saturday
  content: {
    español: `Dios te salve, Reina y Madre de misericordia, vida, dulzura y esperanza nuestra; Dios te salve. A Ti llamamos los desterrados hijos de Eva; a Ti suspiramos, gimiendo y llorando, en este valle de lágrimas. Ea, pues, Señora, abogada nostra, vuelve a nosotros esos tus ojos misericordiosos; y después de este destierro muéstranos a Jesús, fruto bendito de tu vientre. ¡Oh clementísima, oh piadosa, oh dulce siempre Virgen María!
...
ut digni efficamur promissiónibus Christi.
