...
export const salmoII: Prayer = {
  id: 'salmo-ii',
  title: 'Salmo II',
  categoryId: 'plan-de-vida',
  showOnDay: 2, // Tuesday
  content: {
    español: `Ant. Su reinado es sempiterno; y todos los reyes le servirán y le acatarán (T.P. Aleluya).
...
12.Abrazad la buena doctrina, no sea que al fin se enoje, y perezcáis fuera del camino, cuando, dentro de poco, se inflame su ira.
...
R.Amén.`,
    latín: `Antiphona: Regnum eius regnum sempitérnum est, et omnes reges sérvient ei et obœdient. (T. P. Allelúia).
...
12. Apprehéndite disciplinam, ne quando irascátur, et pereátis de via, cum exárserit in brevi ira eius.
Beati omnes, qui confídunt in eo.

Gloria Patri, et Filio et Spiritui Sancto.
Sicut erat in princípio, et nunc et semper, et in saecula saeculorum.
Amen.
