...
**Planificacion:**
- Conservar íntegramente el historial existente sin obligar a cargarlo en cada tarea.
- Dejar `AGENTS.md` como guía operativa breve y registrar en el historial únicamente intervenciones sustantivas.

**Ejecucion:**
- Se creó `AGENTS-history.md` como copia íntegra del `AGENTS.md` anterior.
- Se reemplazó `AGENTS.md` por las reglas vigentes de prioridad, alcance mínimo, edición, verificación, continuidad y registro.
- Se estableció que las futuras entradas del historial cubran solo correcciones funcionales, cambios de arquitectura, decisiones relevantes, migraciones y validaciones importantes; se excluyen cambios mecánicos o triviales.

**Validacion:**
- Antes de reemplazar `AGENTS.md`, ambos archivos coincidieron mediante SHA-256: `D286AEE52DA66E518A5EAF2636149AC7E1DA1FB283DBA6B84ADA9AE6813032E9`.
- Se comprobó que el nuevo `AGENTS.md` contiene las reglas operativas y remite al historial completo.
- Las entradas históricas anteriores permanecen en `AGENTS-history.md` sin alteraciones.

**Archivos Modificados:**
- AGENTS.md
- AGENTS-history.md

### [2026-09-25] 339. Regla de alcance mínimo para optimizar el contexto

**Planificacion:**
- Reducir lecturas y búsquedas innecesarias en tareas breves, especialmente traducciones, redacción y preguntas generales.
- Aplicar la misma regla en las instrucciones globales y en este repositorio.

**Ejecucion:**
- Se añadió una sección `Regla de alcance mínimo` al archivo global de instrucciones del usuario.
- Se añadió la regla equivalente al inicio de este archivo, antes del historial, para que las tareas de Cotidie comiencen con un alcance acotado.
- Se mantuvieron intactas las entradas históricas y las demás reglas del repositorio.

**Validacion:**
- Se revisaron ambos encabezados después de la edición.
- La regla distingue explícitamente entre solicitudes conversacionales simples y tareas que sí requieren inspección del repositorio.

**Archivos Modificados:**
- C:\Users\balca\.copilot\instructions\AGENTS.instructions.md
- AGENTS.md
